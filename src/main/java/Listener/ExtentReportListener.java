...
import com.tyss.genericUtilities.ReportUtility;
import com.tyss.genericUtilities.UtilityInstanceTransfer;
...
public class ExtentReportListener implements ITestListener, ISuiteListener
{
	...
	public void onStart(ISuite suite) 
	{
		...
		report.init(FrameworkConstant.TEST_EXTENT_REPORT_FILE_PATH, propertyutility.getPropertyData(PropertyKey.EXTENTREPORTTITLE), propertyutility.getPropertyData(PropertyKey.EXTENTREPORTNAME), propertyutility.getPropertyData(PropertyKey.BROWSER));
		sreport = report;
	}
	...
	public void onStart(ITestContext context)  //BT
	{
		...
		//		propertyutility = new PropertyUtility(FrameworkConstant.TEST_PROPERTY_FILE_PATH);
		//		
		//		report = new ReportUtility(FrameworkConstant.TEST_EXTENT_REPORT_FILE_PATH, propertyutility.getPropertyData(PropertyKey.EXTENTREPORTTITLE), propertyutility.getPropertyData(PropertyKey.EXTENTREPORTNAME), propertyutility.getPropertyData(PropertyKey.BROWSER));
	}
